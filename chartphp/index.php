    ...
    <div class="container-fluid">
      <div class="row-fluid">
          ...
          <div class="row-fluid">
            <div class="span6">
				...
				<div class="tab-content" id="grid-demo-tabs-content1">
					...
					<iframe style="overflow:auto" onload="iframeLoaded(this)" name="demo_frame" frameborder="0" width="100%" height="500" src="demos/basic/line.php"></iframe>
					</div>
		...
		<script>
			...
			jQuery('#code').load('index.php?file=/basic/line.php');
