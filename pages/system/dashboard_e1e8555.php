            ...
            <form method="GET" class="row g-3 align-items-end">
                ...
                <div class="col-md-3 d-flex gap-2 justify-content-end align-items-end">
                    ...
                    <a href="export_dashboard.php?<?= $export_params ?>" 
                        ...
                        id="exportBtn"
                        onclick="return exportWithCharts(this)">
...
<!-- Chart Export Form — MUST be outside the filter form above -->
...
<script>
function exportWithCharts(link) {
    const charts = {
    ...
    for (const [inputId, canvasId] of Object.entries(charts)) {
    ...
    document.getElementById('chartExportForm').submit();
    return false;
}
</script>
            <!-- FX rate notice -->
