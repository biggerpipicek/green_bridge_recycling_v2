                    ...
                    <form method="POST" action="" enctype="multipart/form-data" class="container mt-4">
                        <div class="row g-3">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="number" inputmode="decimal" pattern="[0-9]*" step="0.01" name="price" class="form-control" required>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" inputmode="decimal" pattern="[0-9]*" step="0.01" name="brutto_weight" class="form-control">
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <div id="materials-container">
                                    <div class="row g-2 material-row mb-2 align-items-center">
                                        ...
                                        <!-- Weight -->
                                        <div class="col-md-3">
                                            <input type="number" inputmode="decimal" pattern="[0-9]*" step="0.01" name="weights[]" 
